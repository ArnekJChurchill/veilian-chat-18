...
app.post("/signup", (req, res) => {
  ...
  if (usersData.users.find(u => u.username === username)) return res.json({ success: false, message: "Username already taken" });
...
// START SERVER
// ======================
app.listen(3000, () => console.log("Veilian-Chat-18 running on http://localhost:3000"));
